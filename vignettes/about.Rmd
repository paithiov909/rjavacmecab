...
{rjavacmecab}は、[takscape/cmecab-java: A Java binding for MeCab](https://github.com/takscape/cmecab-java)をrJava経由で呼び出してMeCabを利用するためのパッケージです。{RMeCab}や{RcppMeCab}に比べて速いわけではないですが、Taggerに引数を渡すことができるため、ほかのRのためのMeCabバインディングよりも低レベルなMeCab APIにアクセスすることができます。
