...
rjavacmecabは[RMeCab](https://github.com/IshidaMotohiro/RMeCab)や[RcppMeCab](https://github.com/junhewk/RcppMeCab)を代替するものではありません。あいだにJavaを経由することから、解析速度は他のパッケージよりも遅い一方で、次にあげるようなアドバンテージがあります。
